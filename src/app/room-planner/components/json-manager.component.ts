  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="text-center">
        ...
        <p class="text-gray-600">Export your current layout or import an existing one</p>
      </div>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
            <div class="p-4 bg-gray-100 border-b border-gray-200 flex justify-between items-center">
              <span class="text-sm font-medium text-gray-700">Current Layout JSON</span>
              <button 
            ...
            <div class="p-4">
              <pre class="text-xs text-gray-700 font-mono bg-white p-3 rounded border overflow-auto max-h-60 whitespace-pre-wrap">{{ exportedJson }}</pre>
            </div>
          </div>
        </div>
